            ...
            <form className="mt-8 grid gap-5">
              ...
              <div>
                ...
                >
                  ...
                  <option>ITSM Analytics</option>
                  <option>ServiceNow + Power BI</option>
                  <option>Microsoft Fabric + ITSM</option>
                  <option>Self-Service Reporting</option>
                  <option>ITSM Integrations</option>
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  I agree that SUFURIVRO may contact me regarding my demo
                  request and related product information.
                </label>
              </div>

              <button
                type="button"
                className="mt-2 inline-flex h-[54px] items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-8 text-[15px] font-black text-white shadow-[0_12px_24px_rgba(249,115,22,.24)] transition hover:-translate-y-0.5"
              >
                Request a Demo
                <ArrowRight size={17} />
              </button>
              ...
              <div className="text-center text-[10px] text-slate-400">
                No obligation. We&apos;ll contact you to arrange a suitable
                time.
              </div>
            </form>
          </div>
