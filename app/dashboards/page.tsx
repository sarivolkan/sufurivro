        ...
        <div className="relative mx-auto grid max-w-[1500px] gap-12 px-6 py-14 lg:grid-cols-[0.78fr_1.22fr] lg:items-center lg:px-10 lg:py-16">
          ...
          <span className="mt-2 block whitespace-nowrap text-[34px] text-[#2563ff] lg:text-[29px]">
            ...
            <div className="mt-7 flex flex-wrap gap-4">
              ...
              <a
                href="/#contact"
                className="inline-flex h-[54px] min-w-[175px] items-center justify-center rounded-xl border border-blue-400 bg-white px-7 text-[14px] font-bold text-blue-700 transition hover:-translate-y-0.5"
              >
                Request Demo
              </a>
            </div>
